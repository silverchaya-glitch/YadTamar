...
CREATE TABLE orders (
  ...
  order_type TEXT NOT NULL CHECK (order_type IN ('STORY_SELECTION','FULL_LIBRARY','ADULT_COLLECTION','GEMARA')),
  delivery_type TEXT NOT NULL CHECK (delivery_type IN ('SELECTED_STORIES','MASTER_LIBRARY','ADULT_COLLECTION','GEMARA','GIFT_STORY')),
